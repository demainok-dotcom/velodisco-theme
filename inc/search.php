	...
	<section class="vd-actu vd-search">
		...
		<?php else : ?>
			<div class="vd-search__empty">
				<p class="vd-search__empty-title">Aucun résultat</p>
				<p class="vd-search__empty-sub">Aucun article ne correspond à votre recherche. Essayez d'autres mots-clés.</p>
			</div>
		<?php endif; ?>
